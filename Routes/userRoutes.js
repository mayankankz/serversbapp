...
userRouter.get('/exportphotos' , user.exportphotos)
userRouter.get('/exportstudentdata',user.exportStudentsData )
...
userRouter.patch('/updateStudent/:id',user.updateStudent )
